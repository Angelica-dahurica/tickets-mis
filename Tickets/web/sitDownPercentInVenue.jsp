...
<%
    ...
    Map sit_downs = (Map) request.getAttribute("sit_downs");
%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var activities = [];
        var sit_down_percent = [];

        <%
        for(Object t : sit_downs.entrySet()) {
        %>
        activities.push('<%=((Map.Entry) t).getKey()%>');
        sit_down_percent.push(<%=((Map.Entry)t).getValue()%>);
        <%
        }
        %>

...
<%
    ...
    Map cities = (Map) request.getAttribute("cities");
%>
...
<div id="container"
     style="width: 800px; height: 430px; margin: 0 auto;
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function() {
        ...
        <%
        for(Object city : cities.entrySet()) {
        %>
            citydata.push(['<%=((Map.Entry) city).getKey()%>', <%=((Map.Entry)city).getValue()%>]);
        <%
        }
        %>

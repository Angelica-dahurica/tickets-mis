...
<%
    ...
    Map pointMembers = (Map) request.getAttribute("pointMembers");
%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <%
        for(Object pointMember : pointMembers.entrySet()) {
        %>
        pointMembers.push(['<%=((Map.Entry) pointMember).getKey()%>', <%=((Map.Entry)pointMember).getValue()%>]);
        <%
        }
        %>

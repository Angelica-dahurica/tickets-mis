...
<%
    ...
    Map priceRangeAccepteds = (Map) request.getAttribute("priceRangeAccepteds");
%>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function() {
        ...
        <%
        for(Object priceRangeAccepted : priceRangeAccepteds.entrySet()) {
        %>
        xdata.push('<%=((Map.Entry) priceRangeAccepted).getKey()%>');
        ydata.push(<%=((Map.Entry)priceRangeAccepted).getValue()%>);
        <%
        }
        %>

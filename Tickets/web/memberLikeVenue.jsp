...
<%
    Map venues = (Map) request.getAttribute("venues");
%>
...
<div id="container"
     style="width: 850px; height: 450px; margin: 0 auto; padding-top: 100px"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <%
        for(Object venue : venues.entrySet()) {
        %>
        venuedata.push(['<%=((Map.Entry) venue).getKey()%>', <%=((Map.Entry)venue).getValue()%>]);
        <%
        }
        %>
